// ============================================================
// pages/Login.jsx - Pagina de inicio de sesion
// ============================================================
          ...
          {paso === 1 ? (
            <>
              ...
              <div className="mt-3 text-right">
                <Link to="/recuperar-password" className="text-slate-500 hover:text-blue-400 text-sm">
            ...
            <>
              ...
              <div className="mb-8 text-center">
                ...
                <h2 className="text-2xl font-black text-white mb-2">Verificacion en dos pasos</h2>
