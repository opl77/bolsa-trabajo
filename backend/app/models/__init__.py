# ============================================================
# models/__init__.py — Todos los modelos de la BD
# ============================================================
...
# ════════════════════════════════════════════════════════════
# USUARIOS — tabla base de autenticación
# ════════════════════════════════════════════════════════════
class Usuario(db.Model):
    ...
    # Clave pública RSA para chat E2E
...
class Mensaje(db.Model):
    ...
    iv                  = db.Column(db.String(50))              # Vector inicialización
