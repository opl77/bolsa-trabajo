...
def create_app(config_name: str = None) -> Flask:
    ...
    allowed_origins = [
        ...
        'https://bolsa-trabajo-git-main-opl77s-projects.vercel.app',
        'https://bolsa-trabajo-delta.vercel.app',
    ]
    ...
    def token_revocado(jwt_header, jwt_payload):
        return jsonify({"error": "Sesion expirada", "codigo": "SESSION_EXPIRED"}), 401

    @jwt.expired_token_loader
    def token_expirado(jwt_header, jwt_payload):
        return jsonify({"error": "Token expirado por inactividad", "codigo": "TOKEN_EXPIRED"}), 401

    @jwt.unauthorized_loader
    def sin_autorizacion(razon):
        return jsonify({"error": "No autorizado", "detalle": razon}), 401
